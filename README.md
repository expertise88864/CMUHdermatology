...
> 2026-09-23 現行模組與驗收入口見 [第一期架構與驗收](docs/第一期架構與驗收_2026-09-23.md)。本文下方的早期 push／審查步驟保留作歷史參考；目前交付以 `AGENTS.md`、`REMOTE_CI_DELIVERY.md` 和 `_delivery.py` 的候選分支、exact-SHA 遠端 CI、正式 `main` 驗證流程為準。
